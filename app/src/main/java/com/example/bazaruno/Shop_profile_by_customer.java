...
public class Shop_profile_by_customer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users=mySharePreferences.GetItemData(this);
        ...
        BringItems(users.getShop_Id());
    }
    void BringItems(String city)
    {

        Log.d(AppConstant.TAG+" shop id",city);
                ...
                city, new VolleyService.VolleyResponseListener() {
                    ...
                    public void onSuccess(String response) {
                        ...
                        if (response.length() < 70) {
                            ...
                            Toast.makeText(Shop_profile_by_customer.this, "Nothing Found", Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                ...
                                adapter = new Main_Gird_View_Adapter(Shop_profile_by_customer.this, itemModelslist);
